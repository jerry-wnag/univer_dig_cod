"""Build the standalone TCCT S92A post-hoc failure-mechanism audit."""
...
WL = ROOT / "TCCT_S92A_FailureMechanismAudit.wl"
NB = ROOT / "TCCT_S92A_FailureMechanismAudit.ipynb"
LAUNCHER = ROOT / "Start_TCCT_S92A_Jupyter.cmd"
PRECOMMIT = ROOT / "TCCT_S92A_Precommit.json"
...
cells = [environment, preflight, protocol, analysis, audit]
WL.write_text("\n\n".join(
...
markdown = {
    ...
    "source": [
        ...
        "\n",
        "This is a post-hoc, read-only audit of the already revealed S92 blind "
        "failure. It is not a new blind test and it does not train, search, retune, "
        "or edit the TCCT core or either frozen model.\n",
        "\n",
        "The audit verifies the immutable S92 archive, reproduces all frozen "
        "predictions, measures paired feature differences and class-support overlap, "
        "and performs explicitly off-manifold cardinality sensitivity probes against "
        "the unchanged classifier. Those probes diagnose decoder dependence only; "
        "they are not realizable-world counterfactual evidence.\n",
        "\n",
        "Run **Kernel -> Restart Kernel and Run All Cells**. Expected runtime is "
        "well under two minutes because graph propagation is not rerun.\n",
    ],
}
...
notebook = {
    "cells": [
        markdown,
        code_cell(environment, "S92A-ENVIRONMENT"),
        code_cell(preflight, "S92A-LOCKED-INPUT-PREFLIGHT"),
        code_cell(protocol, "S92A-PROTOCOL"),
        code_cell(analysis, "S92A-FAILURE-ANALYSIS"),
        code_cell(audit, "S92A-AUDIT-AND-CERTIFICATE"),
    ],
    "metadata": {
        "kernelspec": {
...
precommit = {
    ...
    "ExpectedWorlds": 80,
    "ExpectedPairs": 40,
    "ExpectedContinueTargets": 40,
    "ExpectedStopTargets": 40,
    "ExpectedOriginalFrozenPredictions": {"Continue": 80, "Stop": 0},
    "ArchiveSHA256": "dfe57246390b8bef52e2bf2bd98e01ba4fecc88091d269067bfb04f2b1b9d3bd",
    "ArchiveManifestSHA256": "4c115bd1f45e407d6bc534a0236b65d150b37359e2afdad7bbe6fddc384ccb09",
    "ArchivePayloadHash": "392721c25845bd8c4c40dd012fafef4ddb9936c68caae697ac5456d8a2bd07e7",
    "FrozenCandidateHash": "703e1365490a0123eac61745876dbcf29066abac4c753bb6ec1f61b790e222fe",
    "S92CertificateSHA256": "22cec6972285fe127e66d740bfdbbf27fbabaa097cb24cc0bbc7196da004a40b",
    "ProtocolHash": "57e107d467055654c89191a893799741877b4206936e3c7d3c3bd4f7dcc9e2d3",
    "ExpectedDiagnosis": "FROZEN_DECODER_CARDINALITY_GATE_DOMINATES_AVAILABLE_RELATIONAL_SIGNAL",
    "ValidatedAuditResultHash": "976a850af3f591b8766f0aeb3439b70678b051e91ef0452c1df77dfebf0fd9f9",
    "OffManifoldProbeWarning": "Sensitivity evidence only; not realizable-world counterfactual evidence",
    "DynamicValidationPassed": True,
    "AuditCellValidatedWithTemporaryCertificate": True,
    "RealS92ACertificateCreatedDuringBuild": False,
