...
(* S87 CELL *)
blindScenarios87=Flatten[
Table[
PrepareScenario87[topology,depth,interventionPair],
...
blindWorldPairs87=Flatten[Lookup[blindScenarios87,"WorldPairs"],1];
baselineWorlds87=Flatten[Lookup[blindScenarios87,"BaselineWorlds"],1];
interventionWorlds87=Flatten[
Lookup[blindScenarios87,"InterventionWorlds"],1
];
blindWorlds87=Join[baselineWorlds87,interventionWorlds87];

summary87=<|
"Scenarios"->Length[blindScenarios87],
"WorldPairs"->Length[blindWorldPairs87],
"Worlds"->Length[blindWorlds87],
"StopPatchedQueryPairs"->Count[
blindWorldPairs87,p_/;TrueQ[p["StopPatchedQuery"]]
],
"NonStopQueryPairs"->Count[
blindWorldPairs87,p_/;!TrueQ[p["StopPatchedQuery"]]
],
"MixedInterventionValidity"->Count[
blindScenarios87,s_/;TrueQ[s["MixedInterventionValidity"]]
],
"MixedInterventionNoConflict"->Count[
blindScenarios87,s_/;TrueQ[s["MixedInterventionNoConflict"]]
],
"MixedEditCountCorrect"->Count[
blindScenarios87,s_/;TrueQ[s["MixedEditCountCorrect"]]
],
"BaselineSameGraphAcrossQueries"->Count[
blindScenarios87,s_/;TrueQ[s["BaselineSameGraphAcrossQueries"]]
],
"InterventionSameGraphAcrossQueries"->Count[
blindScenarios87,s_/;TrueQ[s["InterventionSameGraphAcrossQueries"]]
],
"MixedInterventionChangesGraph"->Count[
blindScenarios87,s_/;TrueQ[s["MixedInterventionChangesGraph"]]
],
"ReferenceRelationsCorrect"->Count[
blindWorldPairs87,p_/;TrueQ[p["ReferenceRelationCorrect"]]
],
"PredictionRelationsCorrect"->Count[
blindWorldPairs87,p_/;TrueQ[p["PredictionRelationCorrect"]]
],
"PairCorrect"->Count[
blindWorldPairs87,p_/;TrueQ[p["PairCorrect"]]
],
"ScenarioPerfect"->Count[
blindScenarios87,s_/;TrueQ[s["AllFourteenWorldsCorrect"]]
],
"BaselineCorrect"->Count[baselineWorlds87,w_/;TrueQ[w["Correct"]]],
"InterventionContinueCorrect"->Count[
interventionWorlds87,
...
"WorldCorrect"->Count[blindWorlds87,w_/;TrueQ[w["Correct"]]],
"CanonicalCaseExactlyBase"->Count[
blindWorlds87,w_/;TrueQ[w["CanonicalCaseExactlyBase"]]
],
"ContractionCountCorrect"->Count[
blindWorlds87,w_/;TrueQ[w["ContractionCountCorrect"]]
],
"ProtectedNodesPreserved"->Count[
blindWorlds87,w_/;TrueQ[w["ProtectedNodesPreserved"]]
],
"ReferenceActionsCorrect"->Count[
blindWorlds87,w_/;SameQ[w["ReferenceAction"],w["Target"]]
],
"NonEmptyTokens"->Count[blindWorlds87,w_/;w["TokenCount"]>0],
"TerminatedNaturally"->Count[
blindWorlds87,w_/;TrueQ[w["TerminatedNaturally"]]
],
"HitSafetyCap"->Count[
blindWorlds87,w_/;TrueQ[w["HitSafetyCap"]]
],
"SevenBranchWorlds"->Count[
blindWorlds87,w_/;SameQ[w["BranchCount"],7]
],
"TotalTraceSeconds"->Total@Lookup[blindWorlds87,"TraceSeconds"]
|>;

byTopology87=Map[
Function[topology,
Module[{scenarios,pairs,base,intervention,worlds},
scenarios=Select[blindScenarios87,SameQ[#["Topology"],topology]&];
...
"ScenarioPerfect"->Count[
scenarios,s_/;TrueQ[s["AllFourteenWorldsCorrect"]]
],
...
"AllFourteenWorldsCorrect"}]&,
blindScenarios87
]],
Dataset[byTopology87],
Dataset[{summary87}]
}]


(* S87 CELL *)
modelHashAfter87=Hash[Normal[frozen75D],"SHA256","HexString"];
candidateHashAfter87=Hash[
Normal[frozenCandidate86E],"SHA256","HexString"
];
coreHashAfter87=Hash[CoreDefinitionBundle87[],"SHA256","HexString"];
canonicalizerHashAfter87=Hash[
{
DownValues[FindPrivateDiamond79B],
DownValues[CanonicalizePrivateDiamonds79B],
DownValues[CanonicalCase79B]
...
topologyHashAfter87=Hash[
{DownValues[DoubleDiamondIn79],DownValues[HierarchicalDiamondIn80]},
"SHA256","HexString"
];
testDefinitionHashAfter87=Hash[
S87TestDefinitionBundle[],"SHA256","HexString"
];
protocolHashAfter87=Hash[Normal[protocol87],"SHA256","HexString"];
...
originalFrozenModelUnchanged87=And[
SameQ[modelHashBefore87,modelHashAfter87],
SameQ[modelHashAfter87,expectedFrozenModelHash79A]
];
frozenCandidateUnchanged87=And[
SameQ[candidateHashBefore87,candidateHashAfter87],
SameQ[candidateHashAfter87,expectedCandidateHash87]
];
coreUnchanged87=SameQ[coreHashBefore87,coreHashAfter87];
canonicalizerUnchanged87=And[
SameQ[canonicalizerHashBefore87,canonicalizerHashAfter87],
SameQ[canonicalizerHashAfter87,expectedCanonicalizerHash87]
];
interventionUnchanged87=And[
SameQ[interventionHashBefore87,interventionHashAfter87],
SameQ[interventionHashAfter87,expectedInterventionHash87]
];
topologiesUnchanged87=SameQ[topologyHashBefore87,topologyHashAfter87];
testDefinitionUnchanged87=SameQ[
testDefinitionHashBefore87,testDefinitionHashAfter87
];
protocolUnchanged87=SameQ[protocolHash87,protocolHashAfter87];
deduplicationMechanismUnchanged87=And[
TrueQ[coreUnchanged87],
TrueQ[testDefinitionUnchanged87],
SameQ[protocol87["TokenDeduplication"],
"DeleteDuplicatesAfterExactRoleCodePairing"]
];

testValidityPassed87=And[
TrueQ[preflightPassed87],
TrueQ[originalFrozenModelUnchanged87],
TrueQ[frozenCandidateUnchanged87],
TrueQ[coreUnchanged87],
TrueQ[canonicalizerUnchanged87],
TrueQ[interventionUnchanged87],
TrueQ[topologiesUnchanged87],
TrueQ[testDefinitionUnchanged87],
...
SameQ[summary87["Scenarios"],28],
SameQ[summary87["WorldPairs"],196],
SameQ[summary87["Worlds"],392],
...
SameQ[summary87["HitSafetyCap"],0],
SameQ[summary87["SevenBranchWorlds"],392]
];

blindPerfect87=And[
TrueQ[testValidityPassed87],
...
"Stage"->"S87",
"Name"->"SevenBranchMixedInterventionBlind",
"CandidateHash"->candidateHashAfter87,
"ProtocolHash"->protocolHashAfter87,
"Depths"->blindDepths87,
"Topologies"->blindTopologies87,
"Scenarios"->summary87["Scenarios"],
"WorldPairs"->summary87["WorldPairs"],
"Worlds"->summary87["Worlds"],
"BaselineCorrect"->summary87["BaselineCorrect"],
"InterventionContinueCorrect"->summary87["InterventionContinueCorrect"],
"InterventionStopCorrect"->summary87["InterventionStopCorrect"],
"WorldCorrect"->summary87["WorldCorrect"],
"PairCorrect"->summary87["PairCorrect"],
"PredictionRelationsCorrect"->summary87["PredictionRelationsCorrect"],
"ScenarioPerfect"->summary87["ScenarioPerfect"],
"OriginalFrozenModelChanged"->!TrueQ[originalFrozenModelUnchanged87],
"FrozenCandidateChanged"->!TrueQ[frozenCandidateUnchanged87],
"CoreChanged"->!TrueQ[coreUnchanged87],
"CanonicalizerChanged"->!TrueQ[canonicalizerUnchanged87],
"InterventionChanged"->!TrueQ[interventionUnchanged87],
"TopologyImplementationsChanged"->!TrueQ[topologiesUnchanged87],
...
"TestValidityPassed"->testValidityPassed87,
"BlindPerfect"->blindPerfect87
|>;

blindResultHash87=Hash[
Normal[resultPayload87],"SHA256","HexString"
];

cert87=Join[
resultPayload87,
<|
"CandidateFrozenBeforeS87"->True,
"TrainingRun"->False,
"CandidateSearchRun"->False,
"PolicyEditApplied"->False,
"RetuningApplied"->False,
...
"S87IsBlindCounterfactualCompositionTest"->True,
"MayClaimBlindSevenBranchMixedInterventionTransfer"->blindPerfect87,
"MayClaimGeneralCounterfactualReasoning"->False,
"MayClaimCausalDiscovery"->False,
"TotalTraceSeconds"->summary87["TotalTraceSeconds"],
"BlindResultHash"->blindResultHash87,
"Outcome"->Which[
!TrueQ[testValidityPassed87],
"INVALID_S87_BLIND_TEST",
TrueQ[blindPerfect87],
...
"S87A_FAILURE_AUDIT_WITHOUT_RETUNING"
]
|>
];
