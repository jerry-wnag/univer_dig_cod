...
Print["S94H aborted: frozen candidate already exists. Preserve it."];Abort[]];
...
candidateExport94H=Quiet@Check[Export[frozenCandidatePath94H,frozenCandidate94H,"WXF"],$Failed];
candidateExported94H=StringQ[candidateExport94H]&&FileExistsQ[frozenCandidatePath94H]&&
FileByteCount[frozenCandidatePath94H]>0;
candidateFileHash94H=If[candidateExported94H,FileSHA256Hex94H[frozenCandidatePath94H],Missing[]];
candidateReloaded94H=If[candidateExported94H,Quiet@Check[
Import[frozenCandidatePath94H,"WXF"],$Failed],$Failed];
...
candidateFrozenBeforeConfirmation94H=And[candidateExported94H,
...
codeMap=AssociationMap[EncodePair94H,rawMap];
...
confirmationScenarios94H=Flatten[Table[<|"Topology"->topology,"TopologyIndex"->ti,
"Context"->context,"ContextIndex"->ci,"Depth"->depth,"BranchCount"->n|>,
{ti,Length[confirmationTopologies94H]},{topology,{confirmationTopologies94H[[ti]]}},
{ci,Length[confirmationContexts94H]},{context,{confirmationContexts94H[[ci]]}},
{depth,confirmationDepths94H},{n,confirmationBranchCounts94H}],4];
