...
ClearAll[CheckpointValidationDiagnostic94H];
CheckpointValidationDiagnostic94H[obj_,idx_Integer,scenario_Association]:=If[
!AssociationQ[obj],
<|"ScenarioIndex"->idx,"Association"->False|>,
<|
"ScenarioIndex"->idx,
"Association"->True,
"StageMatched"->SameQ[obj["Stage"],"S94H"],
"HarnessRevisionMatched"->SameQ[obj["HarnessRevision"],3],
"ScenarioIndexMatched"->SameQ[obj["ScenarioIndex"],idx],
"ScenarioMatched"->SameQ[obj["Scenario"],scenario],
"CandidateHashMatched"->SameQ[obj["CandidateHash"],candidateObjectHash94H],
"CandidateFileHashMatched"->SameQ[obj["CandidateFileHash"],candidateFileHash94H],
"ProtocolHashMatched"->SameQ[obj["ProtocolHash"],confirmationProtocolHash94H],
"DefinitionHashMatched"->SameQ[obj["DefinitionHash"],confirmationDefinitionHashBefore94H],
"PairCountMatched"->SameQ[obj["PairCount"],scenario["BranchCount"]],
"WorldCountMatched"->SameQ[obj["WorldCount"],2 scenario["BranchCount"]],
"PairsAreAssociations"->VectorQ[obj["Pairs"],AssociationQ],
"PairLengthMatched"->SameQ[Length[obj["Pairs"]],scenario["BranchCount"]],
...
"StoredDefinitionHash"->obj["DefinitionHash"],
"CurrentDefinitionHash"->confirmationDefinitionHashBefore94H,
"StoredProtocolHash"->obj["ProtocolHash"],
"CurrentProtocolHash"->confirmationProtocolHash94H,
"StoredCheckpointHash"->obj["CheckpointHash"],
"RecomputedCheckpointHash"->Hash[Normal@KeyDrop[obj,{"CheckpointHash"}],
"SHA256","HexString"]
|>
];
...
Print[InputForm[CheckpointValidationDiagnostic94H[
existingCheckpoint94H,scenarioIndex94H,scenario94H]]];
