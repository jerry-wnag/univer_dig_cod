...
k33CandidatePath94C="E:/engine_wolf/TCCT_S86E_K33FrozenCandidate.wl";
baseRuntimePath94C="E:/engine_wolf/TCCT_S87D_FrozenDecoderRuntime.wl";
baseCandidatePath94C="E:/engine_wolf/TCCT_S87D_FrozenWorldMultisetDecoder.wxf";
pairRuntimePath94C="E:/engine_wolf/TCCT_S92B_PairedContrastDecoderRuntime.wl";
pairCandidatePath94C="E:/engine_wolf/TCCT_S92B_FrozenPairedContrastDecoder.wxf";
...
ClearAll[FileSHA256Hex94C,CoreDefinitionBundle94C,
PairRuntimeDefinitionBundle94C];
FileSHA256Hex94C[path_String]:=If[FileExistsQ[path],
IntegerString[FileHash[path,"SHA256"],16,64],Missing["FileMissing",path]];
CoreDefinitionBundle94C[]:=CoreDefinitionBundle86[];
PairRuntimeDefinitionBundle94C[]:={DownValues[TCCTPairContrastVectorS92B],
...
requiredFiles94C={k33CandidatePath94C,baseRuntimePath94C,
baseCandidatePath94C,pairRuntimePath94C,pairCandidatePath94C,s94aAuditPath94C,
s94bCertificatePath94C,s94bArtifactPath94C};
If[!And@@(FileExistsQ/@requiredFiles94C),
Print["S94C aborted: one or more locked inputs are missing."];
Dataset[AssociationThread[requiredFiles94C,FileExistsQ/@requiredFiles94C]];Abort[]];
If[FileExistsQ[resultCertificatePath94C]&&
FileByteCount[resultCertificatePath94C]>0,
Print["S94C aborted: a prior development certificate exists. Preserve it."];Abort[]];
If[FileExistsQ[developmentPairsPath94C]&&
FileByteCount[developmentPairsPath94C]>0,
Print["S94C aborted: a prior development-pair artifact exists. Preserve it."];Abort[]];

fileHashesBefore94C=FileSHA256Hex94C/@requiredFiles94C;
Clear[frozenCandidate86E];Get[k33CandidatePath94C];
k33HashLoaded94C=Hash[Normal[frozenCandidate86E],"SHA256","HexString"];
Get[baseRuntimePath94C];
baseDecoderLoaded94C=Quiet@Check[
TCCTLoadFrozenDecoderS87D[baseCandidatePath94C],$Failed];
baseDecoderRaw94C=If[AssociationQ[baseDecoderLoaded94C],
KeyDrop[baseDecoderLoaded94C,{"Classifier"}],$Failed];
Get[pairRuntimePath94C];
pairDecoderLoaded94C=Quiet@Check[
TCCTLoadFrozenPairDecoderS92B[pairCandidatePath94C],$Failed];
pairDecoderRaw94C=If[AssociationQ[pairDecoderLoaded94C],
KeyDrop[pairDecoderLoaded94C,{"Policy"}],$Failed];
...
modelHashBefore94C=Hash[Normal[frozen75D],"SHA256","HexString"];
k33ObjectHashBefore94C=Hash[Normal[frozenCandidate86E],"SHA256","HexString"];
baseDecoderObjectHashBefore94C=Hash[Normal[baseDecoderRaw94C],"SHA256","HexString"];
pairDecoderObjectHashBefore94C=Hash[Normal[pairDecoderRaw94C],"SHA256","HexString"];
coreHashBefore94C=Hash[CoreDefinitionBundle94C[],"SHA256","HexString"];
canonicalizerHashBefore94C=Hash[{DownValues[FindPrivateDiamond79B],
DownValues[CanonicalizePrivateDiamonds79B],DownValues[CanonicalCase79B]},
"SHA256","HexString"];
interventionHashBefore94C=Hash[{DownValues[LocalMediatorSources82],
DownValues[FullSemanticPatch82],DownValues[LocalMediatorPatch82],
DownValues[ReferenceAction82]},"SHA256","HexString"];
topologyPrimitiveHashBefore94C=Hash[{DownValues[DiamondIn72],
DownValues[DoubleDiamondIn79],DownValues[HierarchicalDiamondIn80]},
"SHA256","HexString"];
baseRuntimeDefinitionHashBefore94C=Hash[
TCCTFrozenFeatureDefinitionBundleS87D[],"SHA256","HexString"];
pairRuntimeDefinitionHashBefore94C=Hash[
PairRuntimeDefinitionBundle94C[],"SHA256","HexString"];

preflightPassed94C=And[
SameQ[modelHashBefore94C,expectedFrozenModelHash94C],
SameQ[k33HashLoaded94C,expectedK33CandidateHash94C],
SameQ[fileHashesBefore94C[[1]],expectedK33CandidateFileHash94C],
AssociationQ[baseDecoderLoaded94C],
SameQ[baseDecoderRaw94C["CandidateHash"],expectedBaseCandidateHash94C],
SameQ[fileHashesBefore94C[[2]],expectedBaseRuntimeFileHash94C],
SameQ[fileHashesBefore94C[[3]],expectedBaseCandidateFileHash94C],
AssociationQ[pairDecoderLoaded94C],
SameQ[pairDecoderRaw94C["CandidateHash"],expectedPairCandidateHash94C],
SameQ[fileHashesBefore94C[[4]],expectedPairRuntimeFileHash94C],
SameQ[fileHashesBefore94C[[5]],expectedPairCandidateFileHash94C],
SameQ[fileHashesBefore94C[[6]],expectedS94AAuditFileHash94C],
AssociationQ[s94aAudit94C],
TrueQ[s94aAudit94C["AuditValidityPassed"]],
SameQ[s94aAudit94C["Outcome"],
...
preflight94C=<|"Stage"->"S94C","Name"->"ExpandedRoleAwareReadoutDevelopment",
"DevelopmentOnly"->True,"BlindTest"->False,
"PreflightPassed"->preflightPassed94C,
"OriginalFrozenModelLocked"->SameQ[modelHashBefore94C,expectedFrozenModelHash94C],
...
If[!TrueQ[preflightPassed94C],Print[Dataset[{preflight94C}]];
Print["S94C aborted: locked-input preflight failed."];Abort[]];
Dataset[{preflight94C}]

(* S94C PREFLIGHT CELL 3 *)
