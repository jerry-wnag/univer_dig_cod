...
(* S86 CELL *)
blindScenarios86=Flatten[
Table[
PrepareScenario86[topology,depth,patchedBranches],
{topology,blindTopologies86},
{depth,blindDepths86},
...
blindWorldPairs86=Flatten[Lookup[blindScenarios86,"WorldPairs"],1];
baselineWorlds86=Flatten[Lookup[blindScenarios86,"BaselineWorlds"],1];
interventionWorlds86=Flatten[
Lookup[blindScenarios86,"InterventionWorlds"],1
];
blindWorlds86=Join[baselineWorlds86,interventionWorlds86];

summary86=<|
"Scenarios"->Length[blindScenarios86],
"WorldPairs"->Length[blindWorldPairs86],
"Worlds"->Length[blindWorlds86],
"PatchedQueryPairs"->Count[
blindWorldPairs86,p_/;TrueQ[p["PatchedQuery"]]
],
"UnpatchedQueryPairs"->Count[
blindWorldPairs86,p_/;!TrueQ[p["PatchedQuery"]]
],
"PatchComponentValidity"->Count[
blindScenarios86,s_/;TrueQ[s["PatchComponentValidity"]]
],
"PatchNoConflict"->Count[
blindScenarios86,s_/;TrueQ[s["PatchNoConflict"]]
],
"PatchEditCountCorrect"->Count[
blindScenarios86,s_/;TrueQ[s["PatchEditCountCorrect"]]
],
"BaselineSameGraphAcrossQueries"->Count[
blindScenarios86,s_/;TrueQ[s["BaselineSameGraphAcrossQueries"]]
],
"InterventionSameGraphAcrossQueries"->Count[
blindScenarios86,s_/;TrueQ[s["InterventionSameGraphAcrossQueries"]]
],
"PatchChangesGraph"->Count[
blindScenarios86,s_/;TrueQ[s["PatchChangesGraph"]]
],
"ReferenceRelationsCorrect"->Count[
blindWorldPairs86,p_/;TrueQ[p["ReferenceRelationCorrect"]]
],
"PredictionRelationsCorrect"->Count[
blindWorldPairs86,p_/;TrueQ[p["PredictionRelationCorrect"]]
],
"PairCorrect"->Count[
blindWorldPairs86,p_/;TrueQ[p["PairCorrect"]]
],
"ScenarioPerfect"->Count[
blindScenarios86,s_/;TrueQ[s["AllTwelveWorldsCorrect"]]
],
"BaselineCorrect"->Count[baselineWorlds86,w_/;TrueQ[w["Correct"]]],
"InterventionContinueCorrect"->Count[
interventionWorlds86,
...
"WorldCorrect"->Count[blindWorlds86,w_/;TrueQ[w["Correct"]]],
"CanonicalCaseExactlyBase"->Count[
blindWorlds86,w_/;TrueQ[w["CanonicalCaseExactlyBase"]]
],
"ContractionCountCorrect"->Count[
blindWorlds86,w_/;TrueQ[w["ContractionCountCorrect"]]
],
"ProtectedNodesPreserved"->Count[
blindWorlds86,w_/;TrueQ[w["ProtectedNodesPreserved"]]
],
"ReferenceActionsCorrect"->Count[
blindWorlds86,w_/;SameQ[w["ReferenceAction"],w["Target"]]
],
"NonEmptyTokens"->Count[blindWorlds86,w_/;w["TokenCount"]>0],
"TerminatedNaturally"->Count[
blindWorlds86,w_/;TrueQ[w["TerminatedNaturally"]]
],
"HitSafetyCap"->Count[
...
scenarios=Select[blindScenarios86,SameQ[#["Topology"],topology]&];
...
"ScenarioPerfect"->Count[
scenarios,s_/;TrueQ[s["AllTwelveWorldsCorrect"]]
],
...
Dataset[byTopology86],
Dataset[{summary86}]
}]


(* S86 CELL *)
modelHashAfter86=Hash[Normal[frozen75D],"SHA256","HexString"];
candidateHashAfter86=Hash[
Normal[frozenCandidate83B],"SHA256","HexString"
];
coreHashAfter86=Hash[CoreDefinitionBundle86[],"SHA256","HexString"];
canonicalizerHashAfter86=Hash[
{
DownValues[FindPrivateDiamond79B],
DownValues[CanonicalizePrivateDiamonds79B],
DownValues[CanonicalCase79B]
...
topologyHashAfter86=Hash[
{DownValues[DoubleDiamondIn79],DownValues[HierarchicalDiamondIn80]},
"SHA256","HexString"
];
testDefinitionHashAfter86=Hash[
S86TestDefinitionBundle[],"SHA256","HexString"
];
protocolHashAfter86=Hash[Normal[protocol86],"SHA256","HexString"];

originalFrozenModelUnchanged86=And[
SameQ[modelHashBefore86,modelHashAfter86],
SameQ[modelHashAfter86,expectedFrozenModelHash79A]
];
frozenCandidateUnchanged86=And[
SameQ[candidateHashBefore86,candidateHashAfter86],
SameQ[candidateHashAfter86,expectedCandidateHash86]
];
coreUnchanged86=SameQ[coreHashBefore86,coreHashAfter86];
canonicalizerUnchanged86=And[
SameQ[canonicalizerHashBefore86,canonicalizerHashAfter86],
SameQ[canonicalizerHashAfter86,expectedCanonicalizerHash86]
];
interventionUnchanged86=And[
SameQ[interventionHashBefore86,interventionHashAfter86],
SameQ[interventionHashAfter86,expectedInterventionHash86]
];
topologiesUnchanged86=SameQ[topologyHashBefore86,topologyHashAfter86];
testDefinitionUnchanged86=SameQ[
testDefinitionHashBefore86,testDefinitionHashAfter86
];
protocolUnchanged86=SameQ[protocolHash86,protocolHashAfter86];
deduplicationMechanismUnchanged86=And[
TrueQ[coreUnchanged86],
TrueQ[testDefinitionUnchanged86],
SameQ[protocol86["TokenDeduplication"],
"DeleteDuplicatesAfterExactRoleCodePairing"]
];

testValidityPassed86=And[
TrueQ[preflightPassed86],
TrueQ[originalFrozenModelUnchanged86],
TrueQ[frozenCandidateUnchanged86],
TrueQ[coreUnchanged86],
TrueQ[canonicalizerUnchanged86],
TrueQ[interventionUnchanged86],
TrueQ[topologiesUnchanged86],
TrueQ[testDefinitionUnchanged86],
TrueQ[protocolUnchanged86],
TrueQ[deduplicationMechanismUnchanged86],
SameQ[summary86["Scenarios"],24],
SameQ[summary86["WorldPairs"],144],
SameQ[summary86["Worlds"],288],
SameQ[summary86["PatchedQueryPairs"],48],
SameQ[summary86["UnpatchedQueryPairs"],96],
SameQ[summary86["PatchComponentValidity"],24],
SameQ[summary86["PatchNoConflict"],24],
SameQ[summary86["PatchEditCountCorrect"],24],
SameQ[summary86["BaselineSameGraphAcrossQueries"],24],
SameQ[summary86["InterventionSameGraphAcrossQueries"],24],
SameQ[summary86["PatchChangesGraph"],24],
...
blindPerfect86=And[
TrueQ[testValidityPassed86],
SameQ[summary86["BaselineCorrect"],144],
SameQ[summary86["InterventionContinueCorrect"],96],
SameQ[summary86["InterventionStopCorrect"],48],
SameQ[summary86["WorldCorrect"],288],
SameQ[summary86["PairCorrect"],144],
SameQ[summary86["PredictionRelationsCorrect"],144],
SameQ[summary86["ScenarioPerfect"],24]
];

resultPayload86=<|
"Stage"->"S86",
"Name"->"ExternalSixBranchBlind",
"CandidateHash"->candidateHashAfter86,
"ProtocolHash"->protocolHashAfter86,
"Depths"->blindDepths86,
"Topologies"->blindTopologies86,
"Scenarios"->summary86["Scenarios"],
"WorldPairs"->summary86["WorldPairs"],
"Worlds"->summary86["Worlds"],
"BaselineCorrect"->summary86["BaselineCorrect"],
"InterventionContinueCorrect"->summary86["InterventionContinueCorrect"],
"InterventionStopCorrect"->summary86["InterventionStopCorrect"],
"WorldCorrect"->summary86["WorldCorrect"],
"PairCorrect"->summary86["PairCorrect"],
"PredictionRelationsCorrect"->summary86["PredictionRelationsCorrect"],
"ScenarioPerfect"->summary86["ScenarioPerfect"],
"OriginalFrozenModelChanged"->!TrueQ[originalFrozenModelUnchanged86],
"FrozenCandidateChanged"->!TrueQ[frozenCandidateUnchanged86],
"CoreChanged"->!TrueQ[coreUnchanged86],
"CanonicalizerChanged"->!TrueQ[canonicalizerUnchanged86],
"InterventionChanged"->!TrueQ[interventionUnchanged86],
"TopologyImplementationsChanged"->!TrueQ[topologiesUnchanged86],
"DeduplicationMechanismChanged"->!TrueQ[deduplicationMechanismUnchanged86],
"TestValidityPassed"->testValidityPassed86,
"BlindPerfect"->blindPerfect86
|>;

blindResultHash86=Hash[
Normal[resultPayload86],"SHA256","HexString"
];

cert86=Join[
resultPayload86,
<|
"CandidateFrozenBeforeS86"->True,
"TrainingRun"->False,
"CandidateSearchRun"->False,
...
"S86IsBlindCounterfactualCompositionTest"->True,
"MayClaimBlindSixBranchCounterfactualTransfer"->blindPerfect86,
"MayClaimGeneralCounterfactualReasoning"->False,
"MayClaimCausalDiscovery"->False,
"TotalTraceSeconds"->summary86["TotalTraceSeconds"],
"BlindResultHash"->blindResultHash86,
"Outcome"->Which[
!TrueQ[testValidityPassed86],
"INVALID_S86_BLIND_TEST",
TrueQ[blindPerfect86],
...
"S86A_FAILURE_AUDIT_WITHOUT_RETUNING"
]
|>
];
