<|"Stage" -> "S125-C-Pilot5", "Completed" -> True, "RunIndex" -> 4, 
 ...
 "Metrics" -> <|"Stage" -> "\"S125-C-Pilot5\"", "StrictProspective" -> 
   ...
   "ConditionalTransitionCells" -> "41", "MembershipQueriesBeforeFreeze" -> 
    "1846", "ReasonValidationAccuracy" -> "0.8197530864197531", 
   ...
   "HighOrderTransitionCases" -> "592", "TCCTTransitionExactAccuracy" -> 
    "1.", "NeuralTransitionExactAccuracy" -> "0.", 
   "TCCTTransitionProbeAccuracy" -> "1.", "NeuralTransitionProbeAccuracy" -> 
    "0.6181225868725869", "NeuralTransitionZeroAccuracy" -> 
    "0.7826013513513513", "NeuralTransitionOneAccuracy" -> 
    "0.20692567567567569", "NeuralTransitionBalancedAccuracy" -> 
    "0.4947635135135135", "TCCTMinusNeuralExact" -> "1.", 
   "TCCTMinusNeuralProbe" -> "0.38996138996138996", 
...
eline_Development\\S125C_Jupyter_Pilot5_MultiRestartMatched_Output\\world_04_\
seed_1258504\\S125C_generated_multirestart_comparison_seed_1258504.wl", 
 "StandardOutputFile" -> "E:\\TCCT_CODEX_HANDOFF_2026-08-13\\S97A_ReadoutBase\
line_Development\\S125C_Jupyter_Pilot5_MultiRestartMatched_Output\\world_04_s\
eed_1258504\\S125C_stdout.log", "StandardErrorFile" -> "E:\\TCCT_CODEX_HANDOF\
F_2026-08-13\\S97A_ReadoutBaseline_Development\\S125C_Jupyter_Pilot5_MultiRes\
tartMatched_Output\\world_04_seed_1258504\\S125C_stderr.log"|>
